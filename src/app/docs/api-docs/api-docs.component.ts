...
export class ApiDocsComponent {
  ...
  docs: Doc[] = [
    ...
    { name: 'Object', method: 'unsetProperty', params: ['object: an object or the name of an object function.', 'string: the path of a property on the object.'], returns: ['boolean: if the property is removed.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'assign', params: ['object: an object or the name of an object function.', 'object: an object or the name of an object function.'], returns: ['object: the newly assigned object.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'merge', params: ['object: an object or the name of an object function.', 'object: an object or the name of an object function.'], returns: ['object: the newly merged object.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'forEach', params: ['object: an object or the name of an object function.', 'fn: a callback function.'], returns: ['object: the original object.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'map', params: ['object: an object or the name of an object function.', 'fn: a callback function.'], returns: ['object: the updated object.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'filter', params: ['object: an object or the name of an object function.', 'fn: a callback function.'], returns: ['array: the filtered values.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'pickBy', params: ['object: an object or the name of an object function.', 'fn: a callback function.'], returns: ['object: the filtered object.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    { name: 'Object', method: 'reduce', params: ['object: an object or the name of an object function.', 'fn: a callback function.', 'any: the initial value.'], returns: ['any: the result of running the reduce function.', 'null: if no object or if there is an error calling the object function.'], info: [] },
    ...
    { name: 'Array', method: 'filter', params: ['array: an array or the name of an array function.', 'fn: a callback function.'], returns: ['array: the filtered array', 'null: if no array, or if there is an error calling the callback function.'], info: [] },
    ...
    { name: 'Workflow', method: 'tryCatch', params: ['simpleVariable: the name of the error.'], returns: [], info: [] },
    ...
    { name: 'Workflow', method: 'error', params: ['string: the error message.'], returns: [], info: ['This app throws an error. Useful for simulating errors while testing.'] },
  ];
