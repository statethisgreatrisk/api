...
export class ApiDocsComponent {
  docs: Doc[] = [
    { name: 'String', method: 'isEqual', params: ['string', 'string'], returns: ['boolean: if param1 is equal to param2.'], info: [] },
    { name: 'String', method: 'isNotEqual', params: ['string', 'string'], returns: ['boolean: if param1 is not equal to param2.'], info: [] },
    
    { name: 'Number', method: 'greaterThan', params: ['number', 'number'], returns: ['boolean: if param1 is greater than param2.'], info: [] },
    { name: 'Number', method: 'greaterThanEqualTo', params: ['number', 'number'], returns: ['boolean: if param1 is greater than or equal to param2.'], info: [] },
    { name: 'Number', method: 'lessThan', params: ['number', 'number'], returns: ['boolean: if param1 is less than than param2.'], info: [] },
    { name: 'Number', method: 'lessThanEqualTo', params: ['number', 'number'], returns: ['boolean: if param1 is less than or equal to param2.'], info: [] },
    { name: 'Number', method: 'isEqual', params: ['number', 'number'], returns: ['boolean: if param1 is equal to param2.'], info: [] },
    { name: 'Number', method: 'isNotEqual', params: ['number', 'number'], returns: ['boolean: if param1 is not equal to param2.'], info: [] },
